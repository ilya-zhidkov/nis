...
{
    internal class DekubitViewModel : Screen
    {
        private readonly DataContext _context;
        private readonly IWindowManager _window;
        private readonly SimpleContainer _container;
        private readonly IEventAggregator _events;
        public DekubitViewModel(DataContext context, SimpleContainer container, IWindowManager window, IEventAggregator events)
        {
            _window = window;
            _context = context;
