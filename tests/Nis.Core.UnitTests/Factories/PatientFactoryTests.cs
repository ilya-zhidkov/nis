...
public class PatientFactoryTests
{
    ...
    [Fact]
    public void it_should_create_ten_patients() => _factory.Create(count: 10).Should().HaveCount(10);

    [Fact]
    public void it_should_throw_if_negative_count_is_passed() => ((Action)(() => _factory.Create(count: -1)))
        .Should()
